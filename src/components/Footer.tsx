      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-lg font-bold text-white">KinLink</span>
            </div>
            <p className="text-sm text-gray-400">
              Connect with your family, preserve relationships, and grow together.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/roadmap" className="hover:text-indigo-400 transition">
                  Roadmap
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/careers" className="hover:text-indigo-400 transition">
                  Careers
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/accessibility" className="hover:text-indigo-400 transition">
                  Accessibility
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-gray-400">
              &copy; {currentYear} KinLink. All rights reserved.
            </p>
